console.warn("==========================Asigniment of Array 01 ===============================================");
...
console.warn("..................Even Position elements.........................");
...
console.warn("..................Odd Position elements.........................");
for (let index = 0; index < array_numbers.length; index++) {
    if(index%2==1)
    {
        const element = array_numbers[index];
    ...
    console.warn(".................Sum of array Elements......................");
    let sum=0;
    for (let index = 0; index < array_numbers.length; index++) {
    ...
    console.warn(`Numbers which are multiple by 5 from given array is ${array_numbers}`);
