...
console.warn("==========================First & Last Element of Given array===============================================");
...
console.warn("==================================Removing Mango from the array=======================================");
console.log(` ${fruits_seasonal.splice(4,1)}`);//elements removed from 4th index and only one elements removed.
console.log(fruits_seasonal);
console.warn("=========================================================================");
